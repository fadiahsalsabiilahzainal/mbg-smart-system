...
> = {
  ...
  // Sayuran (Sudah disamakan dengan Backend)
  tumis_wortel: { nama: "Olahan Wortel", bdd: 100, kalori: 41, protein: 0.7, lemak: 1.5, karbo: 7.1, berat_porsi: 50 },
  ...
  // Buah-buahan (Sudah disamakan dengan Backend)
